...
export const loadCustomContacts = async () => {
  ...
  for (const c of savedContacts) {
    ...
    const customChat = {
      ...
      voiceProvider: c.voiceProvider === 'seed_audio' || c.voiceProvider === 'gemini' || c.voiceProvider === 'elevenlabs' || c.voiceProvider === 'microsoft_mai' || c.voiceProvider === 'aliyun_tts' || c.voiceProvider === 'doubao_tts' ? c.voiceProvider : 'minimax',
