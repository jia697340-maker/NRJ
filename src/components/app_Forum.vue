...
<template>
  <div class="forum-app-container" :class="{'is-dark':globalSettings.darkMode,'is-light':!globalSettings.darkMode}">
    ...
    <template v-else-if="forum.currentForumUser.value">
      ...
      <ForumRefreshModal :visible="refreshVisible" :characters="characterUsers" :busy="forum.busy.value" :progress="forum.generationProgress.value" :error="forum.error.value" @close="refreshVisible=false" @confirm="runGeneration"/>
