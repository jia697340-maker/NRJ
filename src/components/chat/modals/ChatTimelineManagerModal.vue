...
.nested-overlay{position:fixed;inset:0;background:rgba(0,0,0,.24);display:flex;align-items:center;justify-content:center;z-index:13000;backdrop-filter:blur(6px)}.timeline-editor{width:min(86vw,360px)}.editor-field{text-align:left;margin:13px 20px}.editor-field label{display:block;font-size:11px;color:var(--text-tertiary,#888);margin-bottom:6px}.editor-field input,.editor-field textarea{box-sizing:border-box;width:100%;border:1px solid var(--border-color,rgba(0,0,0,.08));background:var(--input-bg,rgba(127,127,127,.06));border-radius:12px;padding:10px 14px;color:var(--text-primary,#222);font:inherit;outline:none}.editor-field textarea{height:74px;resize:none}.editor-field input:focus,.editor-field textarea:focus{border-color:rgba(143,124,255,.55);box-shadow:0 0 0 3px rgba(143,124,255,.08)}.editor-tip{font-size:11px;line-height:1.55;color:var(--text-tertiary,#888);text-align:left;background:rgba(143,124,255,.07);padding:10px 12px;border-radius:10px;margin:0 20px 14px}
.delete-choice{display:flex;text-align:left;gap:10px;padding:12px;border:1px solid var(--border-color,rgba(0,0,0,.08));border-radius:13px;margin:9px 20px;cursor:pointer}.delete-choice>span{width:12px;height:12px;border:2px solid #aaa;border-radius:50%;margin-top:2px}.delete-choice.active{border-color:rgba(143,124,255,.5);background:rgba(143,124,255,.05)}.delete-choice.active>span{border-color:#8f7cff;background:#8f7cff}.delete-choice b,.restore-actions b{font-size:12px;color:var(--text-primary,#333);display:block}.delete-choice small,.restore-actions small{font-size:9px;color:var(--text-tertiary,#999)}.restore-actions{display:grid;grid-template-columns:1fr 1fr;gap:9px;margin:16px 20px}.restore-actions>div{padding:13px;border:1px solid var(--border-color,rgba(0,0,0,.08));border-radius:13px;cursor:pointer}.confirm-btn.full{width:100%}
.reconstruction-modal{max-height:80vh;overflow:auto}.reconstruction-list{text-align:left;padding:0 20px}.reconstruction-list p{font-size:10px;line-height:1.6;padding:8px 10px;margin:7px 0;background:rgba(127,127,127,.06);border-radius:10px;color:var(--text-secondary,#666)}.reconstruction-list b{display:block;font-size:11px;color:var(--text-primary,#333);margin-bottom:2px}
